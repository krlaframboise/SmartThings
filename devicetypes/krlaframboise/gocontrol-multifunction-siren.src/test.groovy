/**
 *  GoControl Multifunction Siren v 1.7 (TEST)
 *
 *  Devices:
...
private alarmTypeSetCmds(alarmType) {
	logTrace "alarmTypeSetCmds(${alarmType})"
	def result = []
...
private alarmTypeSetCmd(alarmType) {
	logTrace "alarmTypeSetCmd(${alarmType})"
...
private autoOffSetCmd(autoOff) {
	logTrace "autoOffSetCmd(${autoOff})"
