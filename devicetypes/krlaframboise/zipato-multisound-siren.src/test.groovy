 ...
 *    - Added Health Check Capability with 5 minute self polling.
 *
 *  1.4.2 (08/06/2016)
...
def updated() {	
    ...
    sendEvent(name: "checkInterval", value: 60 * 12, displayed: false, data: [protocol: "zwave", hubHardwareId: device.hub.hardwareID])
