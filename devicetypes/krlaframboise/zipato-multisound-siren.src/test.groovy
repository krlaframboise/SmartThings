 ...
 *    - Removed parameter types because Speaker Notify with Sound and SHM do not use them the way that they're documented.
 *    - Added switch multilevel which is what the documentation says to use to play different sounds, but that command class is not in the zwave description and doesn't work with the US version.
 *
 *  1.4.2 (08/06/2016)
