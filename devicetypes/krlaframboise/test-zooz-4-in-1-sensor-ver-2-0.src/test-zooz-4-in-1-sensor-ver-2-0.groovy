/**
 *  (TEST) Zooz 4-in-1 Sensor VER 2.0 
 *		(Model: ZSE40)
 *
 *  Author: 
...
metadata {
	definition (
		name: "TEST - Zooz 4-in-1 Sensor VER 2.0",
	...
	preferences {
		...
		//*****  TESTING *****
		// getDecimalInput("rhForcedVal", "Forced RH Value:", "0..100", 0)
		// getDecimalInput("tempForcedVal", "Forced Temp Value:", "0..200", 0)
		// getDecimalInput("lxForcedVal", "Forced Lux Value:", "0..200", 0)
		// getDecimalInput("lightForcedVal", "Forced Light Value:", "0..100", 0)
		 // getDecimalInput("batteryForcedVal", "Forced Battery Value:", "0..100", 0)
		 // getBoolInput("motionForcedActive", "Force Motion Active:", false)
		 // getBoolInput("tamperForcedDetected", "Force Tamper Detected:", false)
		//*****  TESTING *****
	...
	tiles(scale: 2) {
		...
		valueTile("temperature", "device.temperature", inactiveLabel: false, width: 2, height: 2) {
			...
			icon: "https://raw.githubusercontent.com/krlaframboise/Resources/master/simple-device-viewer/normal-temp.png"
			//icon: "st.alarm.temperature.normal"
			// ,
			// backgroundColors:[
		...
		valueTile("humidity", "device.humidity", inactiveLabel: false, width: 2, height: 2){
			state "humidity", label:'${currentValue}%', icon: "https://raw.githubusercontent.com/krlaframboise/Resources/master/Zooz/humidity-default.png"
			state "1", label:'${currentValue}%', icon: "https://raw.githubusercontent.com/krlaframboise/Resources/master/Zooz/humidity-dry.png"
			state "100", label:'${currentValue}%', icon: "https://raw.githubusercontent.com/krlaframboise/Resources/master/Zooz/humidity-wet.png"
		}
		
		valueTile("pLight", "device.pLight", inactiveLabel: false, width: 2, height: 2){
			state "default", label:'${currentValue}%', icon: "https://raw.githubusercontent.com/krlaframboise/Resources/master/Zooz/light-default.png"
			state "1", label:'${currentValue}%', icon: "https://raw.githubusercontent.com/krlaframboise/Resources/master/Zooz/light-dark.png"
			state "100", label:'${currentValue}%', icon: "https://raw.githubusercontent.com/krlaframboise/Resources/master/Zooz/light-bright.png"
		}

		valueTile("lxLight", "device.lxLight", inactiveLabel: false, width: 2, height: 2){
			state "default", label:'${currentValue}lx', icon: "https://raw.githubusercontent.com/krlaframboise/Resources/master/Zooz/light-default.png"
			state "1", label:'${currentValue}lx', icon: "https://raw.githubusercontent.com/krlaframboise/Resources/master/Zooz/light-dark.png"
			state "100", label:'${currentValue}lx', icon: "https://raw.githubusercontent.com/krlaframboise/Resources/master/Zooz/light-bright.png"
		}
		
		valueTile("motion", "motion", decoration: "flat", inactiveLabel: false, width: 2, height: 2){		
			state "inactive", label:'No Motion', icon: "https://raw.githubusercontent.com/krlaframboise/Resources/master/Zooz/motion-inactive.png"//, backgroundColor: "#cccccc"
			state "active", label:'Motion', icon: "https://raw.githubusercontent.com/krlaframboise/Resources/master/Zooz/motion-active.png"//, backgroundColor: "#00a0dc"
		}			
		
		standardTile("tampering", "device.tamper", inactiveLabel: false, width: 2, height: 2) {			
			state "clear", label:'No Tamper', icon: "st.secondary.activity"//, backgroundColor:"#cccccc"
			state "detected", label:'Tamper', icon: "st.secondary.activity", action: "clearTamper"//, backgroundColor: "#e86d13"
		}
		
		valueTile("battery", "device.battery", inactiveLabel: false, width: 2, height: 2){
			state "default", label:'${currentValue}%', icon: "https://raw.githubusercontent.com/krlaframboise/Resources/master/Zooz/battery-default.png"
			state "1", label:'${currentValue}%', icon: "https://raw.githubusercontent.com/krlaframboise/Resources/master/Zooz/battery-low.png"
			state "100", label:'${currentValue}%', icon: "https://raw.githubusercontent.com/krlaframboise/Resources/master/Zooz/battery-full.png"
		}
...
def updated() {	
	...
	if (!isDuplicateCommand(state.lastUpdated, 3000)) {
		...
		// sendForcedEvent("humidity", settings?.rhForcedVal)
		// sendForcedEvent("temperature", settings?.tempForcedVal)
		// sendForcedEvent("lxLight", settings?.lxForcedVal)
		// sendForcedEvent("pLight", settings?.lightForcedVal)
		// sendForcedEvent("battery", settings?.batteryForcedVal)
		// sendForcedEvent("motion", settings?.motionForcedActive ? "active" : "inactive")
		// sendForcedEvent("tamper", settings?.tamperForcedDetected ? "detected" : "clear")		
		sendLastCheckinEvent()
		sendForcedEvent("humidity", 100)
		sendForcedEvent("temperature", 70)
		sendForcedEvent("lxLight", 45)
		sendForcedEvent("pLight", 100)
		sendForcedEvent("battery", 100)
		sendForcedEvent("motion", "active")
		sendForcedEvent("tamper", "clear")
		//******   TESTING *****
	}	
}
