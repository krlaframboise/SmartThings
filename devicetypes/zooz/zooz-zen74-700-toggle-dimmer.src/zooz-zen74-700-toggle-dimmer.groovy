/*
 *  Zooz ZEN74 700 Toggle Dimmer VER. 1.0
 *
 *  Changelog:
 *
 *    1.0 (04/18/2020)
...
@Field static Map assocGroups = [2:"associationGroupTwo", 3:"associationGroupThree"]
...
metadata {
	definition (
		name: "Zooz ZEN74 700 Toggle Dimmer",
		namespace: "Zooz",
		author: "Kevin LaFramboise (@krlaframboise)",
		ocfDeviceType: "oic.d.switch",
		mnmn: "SmartThingsCommunity",
		vid: "4e72eb07-daf6-3c34-9995-71d272e70cbf"
	) {
		capability "Actuator"
		capability "Sensor"
		capability "Switch"
		...
		fingerprint mfr:"027A", prod:"7000", model: "A004", deviceJoinName:"Zooz ZEN74 700 Toggle Dimmer"
	}
...
List<String> getSetLevelCmds(level, duration=null) {
	...
	List<String> cmds = [
		switchMultilevelSetCmd(levelVal, durationVal)
	]
	return cmds
}
...
Map getRelayControlParam() {
	return getParam(15, "Relay Control", 1, 1, [1:"Enable Toggle and Z-Wave [DEFAULT]", 0:"Disable Toggle", 2:"Disable Toggle and Z-Wave"])
}
...
Map getDisabledRelayBehaviorParam() {
	return getParam(21, "Disabled Relay Behavior", 1, 0, [0: "Reports Status [DEFAULT]", 1: "Doesn't Report Status"])
}
