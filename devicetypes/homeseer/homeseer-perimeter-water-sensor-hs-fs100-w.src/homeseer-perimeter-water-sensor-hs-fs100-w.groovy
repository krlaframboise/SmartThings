/*
 *  HomeSeer Perimeter Water Sensor v1.0
 *  	(Model: HS-FS100-W)
 *
 *
 *  Changelog:
...
metadata {
	definition (
		name: "HomeSeer Perimeter Water Sensor HS-FS100-W",
		namespace: "HomeSeer",
		author: "Kevin LaFramboise (krlaframboise)",
		ocfdevicetype: "x.com.st.d.sensor.moisture",
		mnmn: "SmartThingsCommunity",
		vid: "04c03961-05f3-31f4-b012-a7ad7298689d"
	) {
		capability "Sensor"
		capability "Actuator"
		...
		fingerprint mfr:"000C", prod:"0202", model:"0001", deviceJoinName: "HomeSeer Perimeter Water Sensor"
	}
...
private handleWaterEvent(event) {
	sendEvent(getEventMap("water", (event ? "wet" : "dry")))
}
