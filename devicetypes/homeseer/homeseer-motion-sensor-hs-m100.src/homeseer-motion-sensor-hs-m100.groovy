/*
 *  HomeSeer Motion Sensor HS-M100 (v1.0)
 *
 *  Changelog:
 *
 *    1.0 (01/17/2021)
...
metadata {
	definition (
		name: "HomeSeer Motion Sensor HS-M100",
		namespace: "HomeSeer",
		...
		fingerprint mfr:"000C", prod:"0201", model:"0009", deviceJoinName: "HomeSeer Motion Sensor HS-M100"
	}
